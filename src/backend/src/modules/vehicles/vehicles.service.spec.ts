...
describe('VehiclesService', () => {
    ...
    describe('create', () => {
        it('should create a new vehicle', async () => {
            ...
            repository.create.mockReturnValue(mockVehicle as Vehicle);
            repository.save.mockResolvedValue(mockVehicle as Vehicle);
        ...
        it('should create vehicle with all optional fields', async () => {
            ...
            repository.create.mockReturnValue(fullVehicle as Vehicle);
            repository.save.mockResolvedValue(fullVehicle as Vehicle);

            const result = await service.create('tenant-uuid', dto);

            expect(result.fuelType).toBe(FuelType.DIESEL);
            expect(result.transmission).toBe(TransmissionType.AUTOMATIC);
        });
    });
    ...
    describe('findOne', () => {
        it('should return a vehicle by id', async () => {
            repository.findOne.mockResolvedValue(mockVehicle as Vehicle);
        ...
        it('should throw NotFoundException if vehicle not found', async () => {
            ...
            await expect(
                service.findOne('tenant-uuid', 'non-existent-uuid'),
            ).rejects.toThrow('Vehicle with ID non-existent-uuid not found');
        });
    });
    ...
    describe('update', () => {
        it('should update a vehicle', async () => {
            ...
            repository.findOne.mockResolvedValue(mockVehicle as Vehicle);
            repository.save.mockResolvedValue(updatedVehicle as Vehicle);
        ...
        it('should throw NotFoundException if vehicle not found', async () => {
            ...
            await expect(
                service.update('tenant-uuid', 'non-existent-uuid', { mileage: 30000 }),
            ).rejects.toThrow(NotFoundException);
        });
    });
    ...
    describe('remove', () => {
        it('should soft delete a vehicle', async () => {
            ...
            repository.findOne.mockResolvedValue(mockVehicle as Vehicle);
            repository.save.mockResolvedValue(deletedVehicle as Vehicle);
    ...
    describe('hardDelete', () => {
        it('should permanently delete a vehicle', async () => {
            repository.findOne.mockResolvedValue(mockVehicle as Vehicle);
            repository.remove.mockResolvedValue(mockVehicle as Vehicle);
    ...
    describe('getVehicleStats', () => {
        it('should return vehicle statistics', async () => {
            ...
            mockQueryBuilder.getRawMany
                ...
                .mockResolvedValueOnce([
                    { fuelType: FuelType.GASOLINE, count: '30' },
                    { fuelType: FuelType.DIESEL, count: '15' },
                    { fuelType: FuelType.ELECTRIC, count: '5' },
                ]);
